...
rcurl.sh -o "/usr/local/bin/preclear_binhex.sh" "https://raw.githubusercontent.com/binhex/scripts/master/shell/unraid/system/preclear/binhex/preclear_binhex.sh"

# mark script as executable
chmod +x "/usr/local/bin/preclear_binhex.sh"

# download readvz (64 bit) utility - referenced by preclear script
rcurl.sh -o "/usr/local/bin/readvz" "https://raw.githubusercontent.com/binhex/scripts/master/shell/unraid/system/preclear/binhex/readvz"
