...
curly.sh -of "/usr/local/bin/preclear_binhex.sh" -url "https://raw.githubusercontent.com/binhex/scripts/master/shell/unraid/system/preclear/binhex/preclear_binhex.sh"

# mark script as executable
chmod +x "/usr/local/bin/preclear_binhex.sh"

# download readvz (64 bit) utility - referenced by preclear script
curly.sh -of "/usr/local/bin/readvz" -url "https://raw.githubusercontent.com/binhex/scripts/master/shell/unraid/system/preclear/binhex/readvz"
